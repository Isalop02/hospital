...
public class Doctor extends Person implements Registrable, Attendable {
    ...
    private List<Specialty> specialties; // UML: Doctor has many specialties
    private String registrationDate;
    private DoctorStatus status;
    private double consultationFee;
    // Relationships
    private List<Appointment> appointments;     // UML: Doctor 1..* Appointment
    private List<MedicalRecord> medicalRecords; // UML: Doctor creates many MedicalRecords
    private List<Treatment> treatments;         // UML: Doctor prescribes many Treatments

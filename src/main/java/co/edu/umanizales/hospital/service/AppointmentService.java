...
public class AppointmentService {
    ...
    private String[] appointmentToArray(Appointment appointment) {
        return new String[]{
            ...
            appointment.getAppointmentDateTime() != null ? appointment.getAppointmentDateTime().format(DATETIME_FORMATTER) : "",
    ...
    private Appointment arrayToAppointment(String[] record) {
        ...
        appointment.setDoctorId(record[2]);
        appointment.setAppointmentDateTime(!record[3].isEmpty() ? LocalDateTime.parse(record[3], DATETIME_FORMATTER) : null);
        appointment.setRegistrationDate(record[4]);
        appointment.setStatus(!record[5].isEmpty() ? Appointment.AppointmentStatus.valueOf(record[5]) : null);
